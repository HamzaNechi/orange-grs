...
import 'package:orange_grs/features/visites/presentation/pages/list_visit.dart';
    ...
    on<BottomNavEvent>((event, emit) {
      ...
      if(event is BottomNavOnChangeEvent){
        switch (event.index){
          ...
          break;
          case 2 : emit(const BottomNavVisiteWidgetState(titleAppBar: "Visites", index: 2, page: ListVisit()));
          break;
        }
      }
    });
